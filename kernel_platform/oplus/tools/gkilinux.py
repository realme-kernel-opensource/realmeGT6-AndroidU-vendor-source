...
# img_path=os.getcwd()+"download"
# options = ChromeOptions()
# options.add_argument(--user-data-dir ="D:\\jenkins\gki\\User Data")

options = webdriver.ChromeOptions()
options.add_argument(r'--user-data-dir=D:\jenkins\gki\User Data')

#options.add_argument(r'--user-data-dir=/work/oppo_80349759/gki/UserData/Default')
#options.add_argument(r'--user-data-dir=/work/oppo_80349759/.config/google-chrome/Default')
