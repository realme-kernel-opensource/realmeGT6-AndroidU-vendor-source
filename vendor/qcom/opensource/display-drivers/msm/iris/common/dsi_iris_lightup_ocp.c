...
#define IRIS_TX_READ_ERR_MASK_IRIS8_FPGA 0x4FEFFEFF
...
static int _iris_pt_read(struct dsi_panel_cmd_set *cmdset, uint8_t path)
{
	...
	if ((iris_platform_get() == IRIS_FPGA) && (pcfg->iris_chip_type == CHIP_IRIS8))
		iris_tx_read_err_mask = IRIS_TX_READ_ERR_MASK_IRIS8_FPGA;
