...
//lixiong2@CONNECTIVITY.WIFI.HARDWARE.MAC.2959708, 2022/06/25, Add for boot wlan mode not use NV mac
...
//fangzhijun@CONNECTIVITY.WIFI.HARDWARE.SWITCH.5634084, 2022/6/12,
...
//lixiong2@CONNECTIVITY.WIFI.HARDWARE.MAC.2959708, 2022/06/25,
...
//fangzhijun@CONNECTIVITY.WIFI.HARDWARE.FTM.5634084, 2023/6/12,
...
#ifdef OPLUS_FEATURE_WIFI_DCS_SWITCH
//TAO.HUI@CONNECTIVITY.WIFI.HARDWARE.SWITCH.2932985, 2023/9/1,
//Add for wifi switch monitor
			       ...
			       int tcdev_id)
{
	...
	if (!dev_node) {
		#ifdef OPLUS_FEATURE_WIFI_DCS_SWITCH
		//TAO.HUI@CONNECTIVITY.WIFI.HARDWARE.SWITCH.2932985, 2023/11/06,
		//Add for wifi switch monitor
