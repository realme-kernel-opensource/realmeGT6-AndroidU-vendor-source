...
//wuguotian@CONNECTIVITY.WIFI.HARDWARE.BDF.7202263 , 2024/04/18
...
//YuanZhiqiang@CONNECTIVITY.WIFI.HARDWARE.MAC.6613896 , 2023/11/30, revert for factory write mac address order: write from mac_address[5] to mac_address[0],so mac address[5] is first
        int i;
