...
//YuanZhiqiang@CONNECTIVITY.WIFI.HARDWARE.MAC.6613896 , 2023/11/30, Add for boot wlan mode not use NV mac
...
//Tao.Hui@CONNECTIVITY.WIFI.HARDWARE.SWITCH.5634084, 2022/6/12,
...
//YuanZhiqiang@CONNECTIVITY.WIFI.HARDWARE.MAC.6613896 , 2023/11/30,
...
static void icnss_driver_event_work(struct work_struct *work)
{
	...
	while (!list_empty(&priv->event_list)) {
		...
		case ICNSS_DRIVER_EVENT_IDLE_SHUTDOWN:
			#ifdef OPLUS_FEATURE_WIFI_DCS_SWITCH
			//TAO.HUI@CONNECTIVITY.WIFI.HARDWARE.SWITCH.2932985, 2023/11/24,
			idle_shutdown = true;
			#endif /* OPLUS_FEATURE_WIFI_DCS_SWITCH */
...
//wuguotian@CONNECTIVITY.WIFI.HARDWARE.FTM.5634084, 2023/6/12,
...
static int icnss_probe(struct platform_device *pdev)
{
	...
	#ifdef OPLUS_FEATURE_WIFI_DCS_SWITCH
	//TaoHui@CONNECTIVITY.WIFI.HARDWARE.SWITCH.5634084, 2022/6/12,
	//Add for wifi switch monitor
	...
	#ifdef OPLUS_FEATURE_WIFI_DCS_SWITCH
	//Tao.Hui@CONNECTIVITY.WIFI.HARDWARE.SWITCH.1162003, 2020/02/24
