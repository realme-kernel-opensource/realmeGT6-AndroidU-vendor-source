...
// XuFenghua@CONNECTIVITY.WIFI.P2P.SMARTMCC.2371952, 2022/8/17, OPLUS_FEATURE_WIFI_CAPCENTER_SMARTMCC
...
//fangzhijun@CONNECTIVITY.WIFI.BASIC.WIFI7.5658958, 2023/07/13, add for dynamic disable 11be
...
static const struct hdd_drv_cmd hdd_drv_cmds[] = {
	...
	// XuFenghua@CONNECTIVITY.WIFI.P2P.SMARTMCC.2371952, 2022/8/20, OPLUS_FEATURE_WIFI_CAPCENTER_SMARTMCC
