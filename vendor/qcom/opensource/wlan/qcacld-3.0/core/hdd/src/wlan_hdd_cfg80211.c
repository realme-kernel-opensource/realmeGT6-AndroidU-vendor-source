				 ...
				 const void *data, int data_len)
{
	...
	// JinXuexue@CONNECTIVITY.WIFI.NETWORK.6687835, 2024/02/29,add for vendor ft ie
	value = false;
...
//ZengHui@CONNECTIVITY.WIFI.CONNECTION.CONNECT.4474498, 2023/02/16
//Add for STBC&MRC
			...
			const void *data, int data_len)
{
	...
	if (!ucfg_pmo_is_active_mode_offloaded(hdd_ctx->psoc)) {
		...
		//CuBotao@CONNECTIVITY.WIFI.CONNECT.AUTH.1189028, 2017/12/31,
...
//ZengHui@CONNECTIVITY.WIFI.NETWORK.ULL.5678687, 2023/05/20
//Add for ULL TX 20M
