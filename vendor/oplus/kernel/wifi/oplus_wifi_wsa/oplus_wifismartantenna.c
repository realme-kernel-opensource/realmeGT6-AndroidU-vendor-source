 ...
 ** Version: 1.0
 ** Date : 2020/08/14
 ** Author: XuFenghua@CONNECTIVITY.WIFI.BASIC.SMARTANTENNA.73749
 ** TAG: OPLUS_FEATURE_WIFI_SMARTANTENNA
 ** ------------------------------- Revision History: ----------------------------
 ** <author>                                <data>        <version>       <desc>
 ** ------------------------------------------------------------------------------
 **XuFenghua@CONNECTIVITY.WIFI.BASIC.SMARTANTENNA.73749 2020/08/14    1.0    OPLUS_FEATURE_WIFI_SMARTANTENNA
 **bingham.fang@CONNECTIVITY.WIFI.BASIC.SMARTANTENNA 2021/06/11      1.1
 *******************************************************************************/
